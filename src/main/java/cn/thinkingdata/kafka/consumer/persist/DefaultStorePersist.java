...
public class DefaultStorePersist implements StorePersist {
    ...
    @Override
    public KafkaConsumerOffset readOffsetFromBackupExternalStore(String topic, int partition) {
    ...
    @Override
    public KafkaConsumerOffset executeWhenReadNullFromBackupExternalStore(String topic, Integer partition) {
    ...
    @Override
    public KafkaConsumerOffset executeWhenReadNullFromMysql(String topic, Integer partition) {
